...
@Slf4j
@AllArgsConstructor
public class DataBaseKusciaControlDatasourceHandler extends AbstractDatasourceHandler {
    ...
    public List<DataSourceTypeEnum> supports() {
        return Lists.newArrayList(DataSourceTypeEnum.DATABASE,DataSourceTypeEnum.MYSQL);
    }
    ...
    public CreateDatasourceVO createDatasource(CreateDatasourceRequest createDatasourceRequest) {
        DatabaseDatasourceInfo info = (DatabaseDatasourceInfo) createDatasourceRequest.getDataSourceInfo();
    ...
    private CreateDatasourceVO createDatasourceInKuscia(CreateDatasourceRequest createDatasourceRequest, DatabaseDatasourceInfo info) {
        log.info("start create datasource in kuscia");
        Domaindatasource.DatabaseDataSourceInfo.Builder builder = Domaindatasource.DatabaseDataSourceInfo.newBuilder()
        ...
        String datasourceId = DomainDatasourceConstants.DATASOURCE_DATABASE_ID_PREFIX.concat(UUIDUtils.random(16));
